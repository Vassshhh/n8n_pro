...
class _N8nChatPageState extends State<N8nChatPage> with TickerProviderStateMixin {
  ...
  quickReplies: [
    ...
    'Bagaimana cara daftar UMKM binaan?',
...
setState(() {
  ...
  final body = {'pertanyaan': question};
          ...
          Align(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: isUser ? const Color(0xFF00ADEF) : Colors.grey[300],
          ...
          children: [
            ListTile(
              ...
              onTap: () {
                ...
                _showImageSourceDialog(); // Buka dialog kamera/galeri
              },
            ),
            ListTile(
  ...
  child: GestureDetector(
    ...
    child: Stack(
      children: [
        ...
        if (_showFloatingMenu) _buildFloatingMenu(),
        if (!_showFloatingMenu)
  Positioned(
    bottom: 80,
    right: 24,
